...
<div id="TitleArea">
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="${ pageContext.request.contextPath}/ToFindByFoodNameServlet" method="get">
...
<div id="MainArea">
    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
		...
		<!--显示数据列表 -->
        <tbody id="TableData">
		<c:forEach var="food" varStatus="sta" items="${requestScope.foodList }">
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		<div class="FunctionButton"><a href="${ pageContext.request.contextPath}/ToShowAddFoodServlet">添加</a></div>
    </div> 
</div>
</body>
</html>