...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/ToAddFoodServlet" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
						...
						<tr>
							<td>简介</td>
							<td><textarea name="text" class="TextareaStyle"></textarea></td>
						</tr>
						<tr>
