...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">广州酒家信息管理平台</b> <!-- <img border="0" src="${pageContext.request.contextPath}/sys/detail/style/images/logo.png" /> -->
        </div>
		<!-- 欢迎用户的文字 -->
		...
		<div id="Head_1_FunctionButton">
			<a target="right" href="javascript:void(0)">
				<img width="78" height="20" src="${pageContext.request.contextPath}/sys/detail/style/images/help2.gif" />
			</a>
			<a target="_parent" href="javascript:void(0)">
				<img width="78" height="20" alt="退出系统" src="${pageContext.request.contextPath}/sys/detail/style/images/logout.gif" />
			</a>
		</div>
	</div>
	<!-- 下部 -->
    <div id="Head_2">
		...
		<div id="Head2_FunctionList">
			...
			<a href="javascript: window.parent.right.history.go(0);">
				<img src="${pageContext.request.contextPath}/sys/detail/style/images/Header_refresh.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>刷新(IE、Chrome)</b>		
			</a>
