					...
					<!-- 循环列出餐品 -->
						...
						<li>
							<dl>
								...
								<dd class="f1">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">锅头肉</a>
								</dd>
								<dd class="f2">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">&yen;23.0</a>
								</dd>
							</dl>
						</li>
						...
						<li>
							<dl>
								...
								<dd class="f1">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">火腿白菜</a>
								</dd>
								<dd class="f2">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">&yen;23.0</a>
								</dd>
						...
						<li>
							<dl>
								...
								<dd class="f1">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">青椒鸡丁</a>
								</dd>
								<dd class="f2">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">&yen;23.0</a>
								</dd>
						...
						<li>
							<dl>
								...
								<dd class="f1">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">香锅肉丸</a>
								</dd>
								<dd class="f2">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">&yen;23.0</a>
								</dd>
		...
		<div id="dish_class">
			...
			<div id="dish_2">
				<ul>
						...
						<li>
							<a href="${pageContext.request.contextPath }/app/detail/caidan.jsp">粤菜</a>
						</li>
