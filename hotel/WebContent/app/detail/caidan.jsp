	...
	<div id="all">
		<div id="menu">
			...
			<div id="top">
				<ul>
					<!-- 循环列出餐品 -->
					<c:forEach var="list" items="${requestScope.pageBean.pageList}">
						<li>
							<dl>
								<dt>
								...
								<dd class="f1">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">${list.foodName}</a>
								</dd>
								<dd class="f2">
									<a href="${pageContext.request.contextPath }/app/detail/caixiangxi.jsp">&yen;36.0</a>
								</dd>
							</dl>
						</li>
						</c:forEach>
