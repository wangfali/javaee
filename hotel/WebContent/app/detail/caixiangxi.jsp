	...
	<div id="all">
		...
		<div id="menu1">
			...
			<div class="menu4">
				...
				<a href="${pageContext.request.contextPath }/app/detail/clientCart.jsp" style="background:url(${pageContext.request.contextPath }/app/detail/style/images/img/order_left_corner_bg.png);">放入餐车</a>
