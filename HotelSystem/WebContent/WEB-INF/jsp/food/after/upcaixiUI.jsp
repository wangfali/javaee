...
<div class="inner bg-light lter" id="nei">
    <form action="${basePath}food/foodType_upcaixi.action" method="post" enctype="multipart/form-data">
        <div style="text-align: center; height: 200px;">
            <br>
            <br>
            
            <label class="label label-default" style="font-size: 2em">菜系名称:</label>
                   <s:textfield  cssClass="input-group-lg"
                    style="font-size: 2em;width: 40%" id="account" name="foodType.typeName"
            ...
            <input type="button" style="font-size: 2em;width: 94px;height: 50px;" value="更新" class="btn btn-info" onclick="doSubmit()">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
